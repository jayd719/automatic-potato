...
public class A04Main {
    ...
    private static final Integer[] testData2 = { 1, 2, 3 };
	...
	CountedItem<Integer> key1 = new CountedItem<>(1);
	CountedItem<Integer> key2 = new CountedItem<>(4);
	System.out.println("	Contains " + key1.getItem() + ": " + source.contains(key1));
	System.out.println("	Contains " + key2.getItem() + ": " + source.contains(key2));
	System.out.println("--");
	System.out.println("Testing Equals");
	final BST<Integer> target = new BST<>();
	for (Integer i : testData2) {
	    CountedItem<Integer> data = new CountedItem<>(i);
	    target.insert(data);
	}

	System.out.println("Source: " + source.levelOrder().toString());
	System.out.println("Target: " + target.levelOrder().toString());
	System.out.println("Equals: " + source.equals(target));
	System.out.println("---");
	System.out.println("Test Retrive");
	System.out.println("Retrive " + key1.getItem() + ": " + source.retrieve(key1));
	System.out.println("Retrive " + key2.getItem() + ": " + source.retrieve(key2));
	System.out.println("---");
	System.out.println("Test IsValid");
	System.out.println("Is valid: " + source.isValid());
	System.out.println(LINE);
	System.out.println();
    }
