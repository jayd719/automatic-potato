...
public class A01Main {
	...
	Object[][] testData = { { "able was I ere I saw Elba", true }, { "A man, a plan, a canal, Panama!", true },
		{ "David", false } };
	...
	Object[][] testData = { { "David", "Avidday" }, { "Tœrrow", "arrowway" }, { "yard", "ardyay" } };
	...
	Object[][] testData = { { "ZBC", 26, "ABC" }, { "ABC", 3, "DEF" }, { "ABC", 30, "EFG" } };
